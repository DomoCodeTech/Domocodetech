        ...
        background:
          theme.palette.mode === "dark"
            ...
            : // Modo claro - efecto prisma suave
              ...
              rgba(52, 204, 168, 0.95) 25%,
              rgba(118, 188, 130, 0.9) 50%,
              rgba(240, 255, 240, 0.95) 75%,
              rgba(255, 255, 255, 1) 100%),
            linear-gradient(240deg,
              rgba(0, 128, 94, 0.03) 0%,
              rgba(0, 149, 255, 0.03) 33%,
              rgba(128, 0, 255, 0.03) 66%,
              rgba(0, 128, 94, 0.03) 100%),
            radial-gradient(circle at 50% 50%,
              rgba(255, 255, 255, 0.9) 0%,
              rgba(240, 255, 252, 0.95) 100%)`,
        "&::before": {
          content: '""',
          position: "fixed",
          top: 0,
          ...
          background:
            theme.palette.mode === "dark"
              ...
              : `radial-gradient(circle at 0% 0%, rgba(0, 128, 94, 0.05) 0%, transparent 50%),
               radial-gradient(circle at 100% 0%, rgba(0, 149, 255, 0.05) 0%, transparent 50%),
               radial-gradient(circle at 100% 100%, rgba(128, 0, 255, 0.05) 0%, transparent 50%),
               radial-gradient(circle at 0% 100%, rgba(255, 198, 0, 0.05) 0%, transparent 50%)`,
          zIndex: 0,
          pointerEvents: "none",
