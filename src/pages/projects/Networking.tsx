      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            <Box
              component="img"
              src={SITE_DATA.projects.images.networking}
              alt={t("projects.networking.title")}
              sx={{
                width: "100%",
                height: "100%",
                objectFit: "cover",
            ...
            >
              ...
              >
                {t("projects.networking.description")}
              </Typography>
            </Box>
          </Box>
          ...
          <Grid container spacing={4}>
              ...
              >
                <CardContent>
                  ...
                  <Typography variant="body1" paragraph>
                    {t("projects.networking.overview")}
                  </Typography>
                </CardContent>
              </Card>
            ...
            <Grid item xs={12} md={4}>
              ...
              >
                <CardContent>
                  <Typography variant="h6" gutterBottom>
                    {t("projects.networking.techStack")}
                  </Typography>
