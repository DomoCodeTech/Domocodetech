...
export const enTranslations = {
  ...
  projects: {
    title: "Our Projects",
    subtitle: "Discover our areas of expertise and featured projects",
    features: {
      ...
      "multi-protocol": "Multiple Protocols",
    ...
    web: {
      ...
      description:
        "Portfolio of innovative web sites and applications, from landing pages to complex enterprise platforms.",
      features: [
        "responsive",
        "cross-browser",
        "modern-ui",
    ...
    mobile: {
      ...
      description:
        "Collection of native and cross-platform mobile applications for various business sectors.",
      features: [
        "mobile-first",
        "offline-mode",
        "push-notifications",
    ...
    homeAutomation: {
      title: "Home Automation",
      description:
        "Smart automation projects for homes and buildings, integrating the latest control and monitoring technologies.",
      features: [
        "voice-control",
        "energy-efficient",
        "remote-access",
    ...
    iot: {
      ...
      description:
        "Innovative IoT solutions that connect devices and systems to create smart and efficient environments.",
      features: [
        "real-time",
        "cloud-integration",
        "ai-integration",
    ...
    networking: {
      ...
      description:
        "Enterprise network infrastructure and system implementations with emphasis on security and performance.",
      features: [
        "security",
        "performance",
        "scalability",
    ...
    electronics: {
      ...
      description:
        "Development of custom electronic solutions, from prototypes to production-ready products.",
      features: [
