...
export const esTranslations = {
  ...
  about: {
    ...
    mission: {
      ...
      description: 'Proporcionar soluciones tecnológicas innovadoras y sostenibles que transformen vidas y negocios.',
      image: 'https://images.pexels.com/photos/3183197/pexels-photo-3183197.jpeg'
    },
    vision: {
      title: 'Nuestra Visión',
      description: 'Ser el socio tecnológico líder en la creación de un mundo más inteligente y conectado.',
      ...
      items: [
        {
          icon: 'innovation',
          title: 'Innovación',
          description: 'Constantemente superando límites y explorando nuevas posibilidades'
        },
        {
          icon: 'quality',
          title: 'Calidad',
